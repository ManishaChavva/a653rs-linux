Feature: GNSS Spoofing Detection
  ...
  Scenario: No plausibility assumed after legitimate movement
    Given the position is at latitude: 55.671315, longitude: 12.521528333, altitude: 9.2, time: 2023-06-20T13:49:00Z, speed: 0.684 
  ...
  Scenario: Plausibility assumed after sudden altitude change
    Given the position is at latitude: 40.7128, longitude: -74.0060, altitude: 10, time: 2023-06-20T14:23:00Z, speed: 0.5
  ...
  Scenario: Plausibility assumed after time drift detected
    Given the position is at latitude: 37.7749, longitude: -122.4194, altitude: 5, time: 2023-06-20T14:10:00Z, speed: 1.0
  ...
  Scenario: No plausibility assumed after excessive speed
    Given the position is at latitude: 34.0522, longitude: -118.2437, altitude: 5, time: 2023-06-20T14:20:00Z, speed: 2.5
  ...
  Scenario: Plausibility assumed after deviation in movement pattern
    Given the position is at latitude: 51.5074, longitude: -0.1278, altitude: 9, time: 2023-06-20T14:30:00Z, speed: 1.2
